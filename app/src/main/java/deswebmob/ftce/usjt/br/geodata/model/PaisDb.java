...
public class PaisDb {
    ...
    public void inserirPais(ArrayList<Pais> paises) {
        ...
        for (Pais pais : paises) {
            ...
            values.put(PaisDbContract.PaisBanco.ABVCOD, pais.getAbvcod());
    ...
    public ArrayList<Pais> listarPaises() {
        ...
        String[] colunas = {
                ...
                PaisDbContract.PaisBanco.ABVCOD,
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                pais.setAbvcod(cursor.getString(cursor.getColumnIndex(PaisDbContract.PaisBanco.ABVCOD)));
