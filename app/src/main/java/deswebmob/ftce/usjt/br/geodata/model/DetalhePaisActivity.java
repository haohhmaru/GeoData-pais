...
import static deswebmob.ftce.usjt.br.geodata.R.layout.activity_detalhe_pais;
...
public class DetalhePaisActivity extends FragmentActivity implements DetalhePaisView {
    ...
    TextView txtNomePais, txtAbvcod, txtRegiao, txtCapital, txtSubRegiao,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtAbvcod = (TextView) findViewById(R.id.txtAbvcod);
    ...
    public void configurarView(Pais pais) {
        ...
        txtAbvcod.setText(this.pais.getAbvcod());
        ...
        bandeira.setImageDrawable(Util.getDrawable(this, this.pais.getAbvcod().toLowerCase()));
